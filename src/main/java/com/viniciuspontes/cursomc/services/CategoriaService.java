...
public class CategoriaService {
	...
	public Categoria find(Integer id) {
		...
		return obj.orElseThrow(() -> new ObjectNotFoundException(
					"Objeto nÃƒÂ£o encontrado! Id: " + id + ", Tipo: " + Categoria.class.getName()));
	}
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("NÃƒÂ£o ÃƒÂ© possÃƒÂ­vel excluir uma categoria que possui produtos");
		}
	}
